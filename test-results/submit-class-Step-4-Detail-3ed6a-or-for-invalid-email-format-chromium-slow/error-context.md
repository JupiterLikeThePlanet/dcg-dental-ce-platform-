...
- Name: submit-class.spec.ts >> Step 4: Details >> shows email validation error for invalid email format
- Location: tests/e2e/submit-class.spec.ts:164:7
...
Locator: locator('text=Invalid email format')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Invalid email format')
        ...
        - generic [ref=e38]:
          ...
          - generic [ref=e47]:
            - generic [ref=e48]:
              ...
              - textbox "Contact Email (optional)" [active] [ref=e50]:
